<%-- 
    Document   : A_tareas_proceso
    Created on : 27-11-2021, 22:27:09
    Author     : diego
--%>
    ...
    <body>
                    ...
                    <ul class="navbar-nav">
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="Controladora?accion=Listar_t_f_d">Tareas realizadas</a></li>
                                <li><a class="dropdown-item" href="Controladora?accion=Listar_t_p_d">Tareas en proceso</a></li>
                                <li><a class="dropdown-item" href="Controladora?accion=Listar_t_r_d">Tareas Rechazadas</a></li>
                                <li><a class="dropdown-item" href="Controladora?accion=Listar_t_es_d">Tareas en espera</a></li>
                            </ul>
                        </li>
                        <li class="nav-item">
        ...
        <div class="container mt-5">
            <div class="table-responsive">
                <h3 class="text-center mb-3">Tareas en proceso</h3>
                    ...
                    <tbody>
                        <c:forEach var="dato" items="${datos}">
                            <tr>
                                ...
                                <td data-label="Estado"><span id="Pava">${dato.getPorcentaje_avance()}%</span></td>
